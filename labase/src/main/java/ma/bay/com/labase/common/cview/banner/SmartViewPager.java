package ma.bay.com.labase.common.cview.banner;
...
import ma.bay.com.labase.common.utlis.DeviceUtils;
...
//        setClipToPadding(false);
    ...
    private void initView() {
        ...
        mViewPager.setPageMargin(mContext.getResources().getDimensionPixelSize(R.dimen.margin6));
        mViewPager.setPadding((DeviceUtils.getWindowWidth(mContext) / 4), 0, (DeviceUtils.getWindowWidth(mContext) / 4), 0);
    ...
    private ViewPager.OnPageChangeListener mPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            mIndicator.setPositionAndOffset(position - 1, positionOffset);
